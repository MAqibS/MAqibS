...
<h3 align="center">Technology Leader | Platform Engineer | DevOps | Data Engineering | Cloud Architect (AWS • Azure • GCP)</h3>
...
- 📊 Built **end-to-end data ecosystems** including ingestion, transformation, streaming, orchestration, and warehousing
- 🧱 Built **distributed ETL/ELT pipelines** using Spark, PySpark, Airflow, ADF, and cloud-native data tools
- ⚡ Developed **real-time streaming pipelines** with Kafka, Kinesis, and Pub/Sub
- 🔁 Automated **CI/CD pipelines** for data & platform services using GitHub Actions, Azure DevOps, and Jenkins
- 🛠 Delivered **production-ready IaC frameworks** using Terraform & Ansible for multi-cloud environments
- 🔧 Built **internal developer platforms (IDP)** enabling self-service deployments, automated onboarding & standardized golden paths
- 🌐 Led data migrations from on-prem to AWS/Azure/GCP with zero downtime
- 💻 Developed **full-stack applications** using .NET, C#, Python, Angular & REST APIs
- 📈 Implemented advanced **monitoring, logging & observability** stacks improving MTTR and system reliability
- 🗄 Designed optimized **data lakehouses** using Delta Lake, BigQuery, and Synapse
